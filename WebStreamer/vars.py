...
from configer import (
    ...
    STREAM_TG_DISK_ONLY, SEND_STREAM_LINK, ADMIN_ID, STREAM_MULTI_CLIENT, MULTI_BOT_TOKENS
)
...
class Var(object):
    ...
    AUTO_DOWNLOAD = STREAM_AUTO_DOWNLOAD if STREAM_AUTO_DOWNLOAD is not None else True
    TG_DISK_ONLY = STREAM_TG_DISK_ONLY if STREAM_TG_DISK_ONLY is not None else False
