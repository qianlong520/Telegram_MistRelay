...
3. **自动下载**: 
   ...
   - 若开启 `STREAM_TG_DISK_ONLY: true`，机器人只会把媒体转发到 TG 网盘频道并入库，不再走服务端 Aria2 下载和后续上传。
...
### [0.2.4] - 2026-03-13 (TG 网盘直转模式)
- **📦 TG 网盘直转**:
  - 服务端设置新增“只使用 TG 网盘”开关。
  - 开启后 Bot 只会把媒体转发到 TG 网盘频道并入库，不再走服务端 aria2 下载和后续上传链路。
- **⚙️ 设置页同步**:
  - Web 端和桌面端的服务端设置页都补上该开关，便于直接切换纯 TG 网盘模式。
- **🧭 网盘导航补口**:
  - Web 端“我的网盘”顶部新增返回上级按钮，目录切换更直接。
